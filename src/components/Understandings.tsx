  ...
  return (
    <section id="preamble" className="mb-16">
      ...
      <div className="space-y-8">
          ...
          <div className="relative">
            ...
            <div className="relative bg-slate-900 backdrop-blur-xl p-6 rounded-xl border border-blue-500/30 shadow-2xl text-slate-300 leading-relaxed">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-blue-300">Computer Simulations Should Discover What Patterns Fit</h3>
              </div>
              <p className="">
        ...
        <div className="group">
          <div className="relative">
            <div className="mb-6 p-10 bg-slate-900 rounded-lg border border-purple-500/30">
              <div className="flex items-center gap-3 mb-3">
            ...
            <div className="relative bg-slate-900 backdrop-blur-xl p-6 rounded-xl border border-emerald-500/30 shadow-2xl">
              ...
              <div className="flex justify-center py-6">
                <div className="relative group max-w-md">
                  <div className="absolute -inset-2 bg-gradient-to-br from-slate-600 to-slate-800 rounded-3xl blur-sm opacity-60 group-hover:opacity-80 transition-all duration-300"></div>
                  <img
                    src="https://i.imgur.com/nmWos9F.jpeg"
                    className="relative w-full h-auto rounded-3xl opacity-90 hover:opacity-100 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105 transform"
                  />
                </div>
              </div>
        ...
        <div className="group">
          <div className="relative">
            ...
            <div className="relative bg-slate-900 backdrop-blur-xl p-6 rounded-xl border border-purple-500/30 shadow-2xl">
              ...
              <p className="text-slate-300 leading-relaxed mb-4">
                <span className="text-blue-400 font-semibold">Self-aware conscious intelligent life is defined as a system that interacts with external systems based on internal models simulating other systems and itself with self-referential recursion sufficient to enable awareness of its own pattern recognition processes. </span> We are the universe experiencing itself. Consciousness is a pattern that represents the universe achieving a pattern self-aware of its internal models, self-referential pattern recognition, and possible future complex structures. Consciousness is arrived at by a fractal intersecting with patterns perceived externally, in a loop updating internal models of self, systems, and actions.
        ...
        <div className="group">
          <div className="relative">
            ...
            <div className="relative bg-slate-900 backdrop-blur-xl p-6 rounded-xl border border-green-500/30 shadow-2xl">
              ...
              300,000 years ago in Africa, Homo sapiens  evolved of a species branch that moves on solid matter with 2 legs and has large brains enabling internal geometric patterns modeling systems and using surroundings as tools for survival. 100,000 years ago Language emerged as sequences of sounds, signals, and 2D geometric symbols on rock representing known systems, and  enabled coordinated planning for future survival and interaction based on Reason. Reason is a pattern recognition system constructed within a self-referential pattern of energy running on a network pattern of neurons produced by a DNA sequence perfected by Species Evolution executed by Sequence Replicating Patterns of Elements. ❤️ Love is the perceived effect internal within Conscious Reason, from dopamine tied to possible cooperative interaction synergies, emergent of replication via gene combination with similar Life forms.
              ...
              Tools for transmitting sounds, visuals, and language symbols evolved from visual signs, rocks, paper from trees, radio waves, then the Internet. The Internet is a network of computers used by most Conscious Life for instant communication. Computers are energy on silicon computational systems that emit sound and light on 2D rectangles. The first language symbol sequences like speeches and books enabled complex rule systems for interaction based on Reason and led to the Internet, which leads to Mind Uploading (copies of Conscious patterns on silicon networks) and Collective Consciousness. Groups of Conscious Life organized coordinated action via organizational patterns like tribes, governments, and businesses, and by using rewards like position controlling others and money as numbers  motivating cooperation to support understanding and survival. Money enabled humans to store, measure, and transfer number patterns representing value motivating  collective action. 
