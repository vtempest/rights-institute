      ...
      <div className="group mb-12">
        <div className="relative">
          ...
          <div className="relative bg-slate-900 backdrop-blur-xl p-8 md:p-12 rounded-xl border border-slate-700/50 shadow-2xl">
            ...
            {/* Day 0 Definition */}
            <div className="mb-8 p-6 bg-gradient-to-r from-orange-900/20 to-red-900/20 rounded-lg border border-orange-500/30">
              ...
              <div className="flex items-start gap-4 p-4 bg-slate-900 rounded-lg border border-slate-700/30">
                <GlowWrapper glowColor="#10b981" size="sm">
                  <Users className="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0 p-1" />
                </GlowWrapper>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-blue-300">Critical Research Priorities</h3>
              </div>
            ...
            <div className="p-6 bg-gradient-to-r from-red-900/20 to-orange-900/20 rounded-lg border border-red-500/30">
              <div className="flex items-center gap-3 mb-4">
                <GlowWrapper glowColor="#ef4444" size="sm">
                  <Clock className="w-6 h-6 text-red-400 animate-pulse p-1" />
                </GlowWrapper>
                <h3 className="text-xl font-bold text-red-300">The Window of Preparation</h3>
              </div>
