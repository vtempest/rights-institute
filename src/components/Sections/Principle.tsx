            ...
            <div className="flex items-start gap-6">
              <div className="relative flex-shrink-0">
                ...
                <GlowWrapper glowColor="#ec4899" size="sm" className="absolute -top-1 -right-1">
                  <a 
                    href={`#r${principle.id}`}
                    className="w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-lg hover:cursor-pointer hover:scale-110 transition-transform duration-200"
                  >
                    {index + 1}
                  </a>
                </GlowWrapper>
