      ...
      <div className="group mb-4">
        ...
        <div id="p1" className="group">
          <div className="relative">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl blur opacity-20 group-hover:opacity-30 transition duration-1000" />
              ...
              <div key={index} id={`p${index + 2}`} className="group/card">
                <GlowWrapper glowColor={section.glowColor} size="md" className="h-full">
                  <div className="relative h-full">
                    <div className={`absolute -inset-0.5 bg-gradient-to-r ${section.color} blur opacity-0 group-hover/card:opacity-20 transition duration-500 rounded-xl`} />
                    <div className="relative h-full bg-slate-900 backdrop-blur-sm p-6 border border-slate-700/50 hover:border-slate-600/70 transition-all duration-300 rounded-xl">
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        <GlowWrapper glowColor={section.glowColor} size="sm">
                          <div className={`w-10 h-10 bg-gradient-to-r ${section.color} flex items-center justify-center shadow-lg group-hover/card:scale-110 transition-transform duration-300 rounded-lg`}>
