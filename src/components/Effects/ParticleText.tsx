...
export function ParticleTextEffect({ words = [] }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    const baseFontSize = Math.min(canvas.width / 10, canvas.height / 3) // Responsive font size
    const fontSize = Math.max(50, Math.min(150, baseFontSize)) // Clamp between 50-150px
