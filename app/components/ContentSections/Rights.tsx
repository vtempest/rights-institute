/**
 * @fileoverview Rights Section Component
 * 
 * The rights section of the Rights Institute website that presents the
 * 10 fundamental rights of conscious life. This section establishes
 * the legal and ethical framework for recognizing and protecting
 * consciousness across different substrates (carbon and silicon).
 * 
 * Features:
 * - 10 detailed rights with explanations and highlights
 * - Interactive principle components
...
import { MorphingText } from "../TextEffects/MorphText";
 ...
 * 
 * @component
 * @returns {JSX.Element} The complete rights section with all 10 principles
 * 
 * @example
 * ```tsx
 * <PrinciplesSection />
    ...
    <section id="principles" className="mb-16">
      ...
      <div className="mb-12">
        <div className="relative bg-slate-900 backdrop-blur-xl p-8 rounded-xl border border-slate-700/50 shadow-2xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl md:text-4xl w-full font-bold text-slate-1000">
                  
                  <MorphingText texts={['10 Rights of Conscious Life']} />
            </h2>
          </div>
        </div>
      </div>
      ...
      <div className="group mb-16">
          <div className="relative">
            <div className="absolute -inset-0.5 bg-linear-to-r  from-purple-600 to-pink-600 rounded-xl blur opacity-20 group-hover:opacity-30 transition duration-1000" />
